 ...
 * return type, function identifier, input arguments, and the function body.
 */
public class FunNode implements Node {

    /**
     * Return type identifier of the function.
     */
    ...
    /**
     * Arraylist of ArgNode that the function needs in input.
     */
    private final ArrayList<ArgNode> params;
    /**
     * Reference to the node that identifies the body of the function.
     */
    ...
    public ArrayList<SemanticError> checkSemantics(Environment env) {
        ...
        // Management of nested functions, control of the baseFun field. If the variable is
        // null, then the function you define is not inside the body of other functions. Otherwise,
        ...
        // If the function has formal parameters, save the number of them.
        ...
        // NOTE: Increase of the nesting level is done in the semantic check of the block.
