	...
	public void merge(SymbolTableWrapper st) {
		symbolTable.forEach((k, v) -> {
			...
			if (e1.getEffect().compareTo(e2.getEffect()) != 0) {
				...
				else if ((e1.getEffect() == STentry.Effects.INITIALIZED && e2.getEffect() == STentry.Effects.USED) || (e1.getEffect() == STentry.Effects.USED && e2.getEffect() == STentry.Effects.INITIALIZED))
					e1.setEffect(STentry.Effects.USED); // IxU | UxI -> U
			}
		});
	}
